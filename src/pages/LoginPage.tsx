...
const LoginPage = () => {
  ...
  return <div className="min-h-screen flex items-center justify-center p-4 bg-cover bg-center relative overflow-hidden bg-xpenergy-primary" style={{
    ...
    backgroundPosition: 'center'
      ...
      <Card className="w-full max-w-md shadow-xl backdrop-blur-sm border border-white/20 z-10 animate-fade-in my-0 mx-0 bg-transparent rounded-3xl px-0 py-0">
        <CardHeader className="text-center space-y-2 bg-transparent">
          <CardTitle className="font-montserrat bg-gradient-to-br from-xpenergy-primary to-xpenergy-secondary bg-clip-text px-0 text-center text-3xl font-extrabold text-xpenergy-background">XP ENERGY PV MAPPER</CardTitle>
